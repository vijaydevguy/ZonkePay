...
//                   value={formData.firstName}
//                   onChange={handleChange}
//                   className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#A93922] focus:border-[#A93922] bg-white"
//                 />
//               </div>
//               <div>
//                 <label
...
//                 value={formData.phone}
//                 onChange={handleChange}
//                 className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#A93922] focus:border-[#A93922]"
//               />
//               </div>
//             </div>
...
//                 value={formData.email}
//                 onChange={handleChange}
//                 className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-[#A93922] focus:border-[#A93922]"
//               />
//             </div>
...
//                 value={formData.identity}
//                 onChange={handleChange}
//                 className="mt-1 block w-full px-3 bg-white py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#A93922] focus:border-[#A93922]"
//               >
//                 <option value="">Select your role</option>
//                 <option value="Merchant">Merchant</option>
//                 <option value="Seller">Seller</option>
...
//                 value={formData.message}
//                 onChange={handleChange}
//                 className="mt-1 block w-full bg-white px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#A93922] focus:border-[#A93922] max-h-[200px]"
//               />
//             </div>
...
//               <button
//                 type="submit"
//                 className="px-6 py-2 text-sm font-medium text-white bg-[#FA5117] rounded-md hover:bg-[#fa3517] transition-colors"
//               >
//                 Submit
//               </button>
//             </div>
