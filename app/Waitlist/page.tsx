  ...
  const validateField = (name: string, value: string): string | undefined => {
    switch (name) {
      ...
      case "phone":
        ...
        // Mobile numbers
        const mobilePrefixes = ["06", "07", "08"];
        if (mobilePrefixes.includes(prefix)) {
          return;
        }

        // Landline numbers (with area codes)
        const landlinePrefixes = ["01", "02", "03", "04", "05"];
        if (landlinePrefixes.includes(prefix)) {
          // Additional validation for area codes could go here
          return;
        }

        return "Invalid South African phone number prefix";
      default:
        return;
    }
  };
        ...
        <div className="flex flex-col gap-4 w-full lg:w-1/2 mb-8 lg:mb-0">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-[#2D6E62] text-lg md:text-[20px]">
              ...
              ZonkePay - Your Ultimate Payment and Shopping Companion.
            </h2>
          </div>
